"""
From https://github.com/mlcommons/algorithmic-efficiency/blob/main/algorithmic_efficiency/halton.py
As recommended by tuning playbook: https://github.com/google-research/tuning_playbook
